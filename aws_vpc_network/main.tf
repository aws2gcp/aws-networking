...
# IGW
module "igw" {
  source = "../../../terraform-modules/aws_internet_gateway"
...
module "public_routes" {
  source         = "../../../terraform-modules/aws_route"
...
module "nat_gateway_eip" {
  source = "../../../terraform-modules/aws_eip"
...
# NAT gateways
module "nat_gateways" {
  source            = "../../../terraform-modules/aws_nat_gateway"
  count             = var.create_nat_gateways == true ? length(var.subnets.private_cidrs) : 0
  subnet_id         = module.public_subnets[count.index].id
...
# EC2 ENIs
module "ec2_enis" {
  source             = "../../../terraform-modules/aws_network_interface"
...
module "ec2_target_group_attachment" {
  source           = "../../../terraform-modules/aws_lb_target_group_attachment"
  for_each         = var.ec2_instances
...
module "lambda_iam_role" {
  source   = "../../../terraform-modules/aws_iam_role"
...
module "lambda_function" {
  source       = "../../../terraform-modules/aws_lambda_function"
  for_each     = var.lambda_functions
  name         = each.key
...
module "lambda_function_alias" {
  source           = "../../../terraform-modules/aws_lambda_alias"
  for_each         = var.lambda_functions
  name             = "live"
...
module "lambda_permissions" {
  source           = "../../../terraform-modules/aws_lambda_permission"
  for_each         = var.lambda_functions
...
module "alb_http_listener" {
  source           = "../../../terraform-modules/aws_lb_listener"
  for_each         = var.albs
...
module "alb_additional_certs" {
  source               = "../../../terraform-modules/aws_lb_listener_certificate"
  for_each             = var.albs
...
module "dns_cname" {
  source      = "../../../terraform-modules/aws_route53_record"
  for_each    = var.albs
...
module "peering_connections" {
  source          = "../../../terraform-modules/aws_vpc_peering_connection"
...
# Customer Gateways
module "cgws" {
  source     = "../../../terraform-modules/aws_customer_gateway"
  for_each   = var.cgws
  name       = each.key
...
module "vpgw" {
  source = "../../../terraform-modules/aws_vpn_gateway"
...
module "vpgw_propogation" {
  source = "../../../terraform-modules/aws_vpn_gateway_route_propagation"
...
# Transit Gateway
module "tgw" {
  source = "../../../terraform-modules/aws_ec2_transit_gateway"
...
module "tgw_attachment" {
  source     = "../../../terraform-modules/aws_ec2_transit_gateway_vpc_attachment"
...
module "vpn_connections" {
  source   = "../../../terraform-modules/aws_vpn_connection"
...
#  source   = "../../../terraform-modules/aws_networkfirewall_firewall"
